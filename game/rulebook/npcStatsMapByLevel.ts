...
export const npcStatsMapByLevel: Record<NonPlayerCharacterId, Record<Level, EnemyDefinition>> = {
    ...
    gnomeBandit: {
        1: { level: '1', strength: 5, magic: 0, defense: 2, constitution: 11, moves: ['gnomeBomb(1)', 'bucketOfBangSnaps', 'fireCracker', 'block'],},
        2: { level: '2', strength: 10, magic: 0, defense: 4, constitution: 22, moves: ['gnomeBomb(1)', 'bucketOfBangSnaps', 'fireCracker', 'block'],},
        3: { level: '3', strength: 15, magic: 0, defense: 6, constitution: 33, moves: ['gnomeBomb(1)', 'bucketOfBangSnaps', 'fireCracker', 'block'],},
        4: { level: '4', strength: 20, magic: 0, defense: 8, constitution: 44, moves: ['gnomeBomb(1)', 'bucketOfBangSnaps', 'fireCracker', 'block'],},
        5: { level: '5', strength: 25, magic: 0, defense: 10, constitution: 55, moves: ['gnomeBomb(1)', 'bucketOfBangSnaps', 'fireCracker', 'block'],},
        6: { level: '6', strength: 30, magic: 0, defense: 12, constitution: 66, moves: ['gnomeBomb(1)', 'bucketOfBangSnaps', 'fireCracker', 'block'],},
        7: { level: '7', strength: 35, magic: 0, defense: 14, constitution: 77, moves: ['gnomeBomb(1)', 'bucketOfBangSnaps', 'fireCracker', 'block'],},
        8: { level: '8', strength: 40, magic: 0, defense: 16, constitution: 88, moves: ['gnomeBomb(1)', 'bucketOfBangSnaps', 'fireCracker', 'block'],},
        9: { level: '9', strength: 45, magic: 0, defense: 18, constitution: 99, moves: ['gnomeBomb(1)', 'bucketOfBangSnaps', 'fireCracker', 'block'],},
        10: { level: '10', strength: 50, magic: 0, defense: 20, constitution: 110, moves: ['gnomeBomb(1)', 'bucketOfBangSnaps', 'fireCracker', 'block'],},
    },
    gnomeProspector: {
        1: { level: 1, strength: 5, magic: 0, defense: 2, constitution: 13, moves: ['yodel', 'demolitionCharge', 'gnomeBomb(1)', 'block'],},
        2: { level: 2, strength: 10, magic: 0, defense: 4, constitution: 26, moves: ['yodel', 'demolitionCharge', 'gnomeBomb(1)', 'block'],},
        3: { level: 3, strength: 15, magic: 0, defense: 6, constitution: 39, moves: ['yodel', 'demolitionCharge', 'gnomeBomb(1)', 'block'],},
        4: { level: 4, strength: 20, magic: 0, defense: 8, constitution: 52, moves: ['yodel', 'demolitionCharge', 'gnomeBomb(1)', 'block'],},
        5: { level: 5, strength: 25, magic: 0, defense: 10, constitution: 65, moves: ['yodel', 'demolitionCharge', 'gnomeBomb(1)', 'block'],},
        6: { level: 6, strength: 30, magic: 0, defense: 12, constitution: 78, moves: ['yodel', 'demolitionCharge', 'gnomeBomb(1)', 'block'],},
        7: { level: 7, strength: 35, magic: 0, defense: 14, constitution: 91, moves: ['yodel', 'demolitionCharge', 'gnomeBomb(1)', 'block'],},
        8: { level: 8, strength: 40, magic: 0, defense: 16, constitution: 104, moves: ['yodel', 'demolitionCharge', 'gnomeBomb(1)', 'block'],},
        9: { level: 9, strength: 45, magic: 0, defense: 18, constitution: 117, moves: ['yodel', 'demolitionCharge', 'gnomeBomb(1)', 'block'],},
        10: { level: 10, strength: 50, magic: 0, defense: 20, constitution: 130, moves: ['yodel', 'demolitionCharge', 'gnomeBomb(1)', 'block'],},
    },
    gnomeBigBomber: {
