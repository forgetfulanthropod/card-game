...
export const enemies: Record<EnemyCharacterId, Record<Level, EnemyDefinition>> = {
    skeletonWarrior: {
        ...
        5: { level: '5', wisdom: 0, constitution: 65, strength: 14, defense: 19, moves: ['swordWack', 'rustyPokeLow', 'slash', 'block', 'swordWack'] },
        6: { level: '6', wisdom: 0, constitution: 87, strength: 17, defense: 22, moves: ['swordWack', 'rustyPokeHigh', 'slash', 'block', 'startlingSpook(1,1)'] },
        7: { level: '7', wisdom: 0, constitution: 101, strength: 20, defense: 25, moves: ['swordWack', 'rustyPokeHigh', 'slash', 'block', 'startlingSpook(2,2)'] },
        8: { level: '8', wisdom: 0, constitution: 121, strength: 23, defense: 28, moves: ['swordWack', 'rustyPokeHigh', 'slash', 'block', 'startlingSpook(2,2)'] },
        9: { level: '9', wisdom: 0, constitution: 135, strength: 26, defense: 31, moves: ['swordWack', 'rustyPokeHigh', 'slash', 'block', 'startlingSpook(3,3)'] },
    ...
    matchaGelatinCube: {
        ...
        5: { level: '5', wisdom: 0, constitution: 80, strength: 11, defense: 26, moves: ['basicAttack', 'surpriseAllergy(2,1)', 'itchyOozeSpecial', 'block', null] },
        6: { level: '6', wisdom: 0, constitution: 105, strength: 14, defense: 31, moves: ['basicAttack', 'surpriseAllergy(3,2)', 'itchyOoze(2)', 'block', 'engulf(50)'] },
        7: { level: '7', wisdom: 0, constitution: 130, strength: 15, defense: 36, moves: ['basicAttack', 'surpriseAllergy(3,2)', 'itchyOoze(2)', 'block', 'engulf(50)'] },
        8: { level: '8', wisdom: 0, constitution: 160, strength: 19, defense: 41, moves: ['basicAttack', 'surpriseAllergy(4,2)', 'itchyOoze(2)', 'block', 'engulf(75)'] },
        9: { level: '9', wisdom: 0, constitution: 175, strength: 22, defense: 48, moves: ['basicAttack', 'surpriseAllergy(4,2)', 'itchyOoze(2)', 'block', 'engulf(75)'] },
        10: { level: '10', wisdom: 0, constitution: 200, strength: 25, defense: 56, moves: ['basicAttack', 'surpriseAllergy(5,2)', 'itchyOoze(2)', 'block', 'engulf(75)'] },
        large: { level: 'large', wisdom: 0, constitution: '200-100', strength: 15, defense: 20, moves: ['matchaMash', 'matchaMadness', 'matchaMeld', null, null] },
