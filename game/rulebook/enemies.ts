...
export const enemies: Record<EnemyCharacterId, Record<Level, EnemyDefinition>> = {
    ...
    gnomeHooligan: {
        1: { level: '1', wisdom: 0, constitution: 10, strength: 10, defense: 6, moves: ['gnomeBomb', 'gnomeBomb', 'gnomeBomb', 'block', 'gnomeBomb'] },
        2: { level: '2', wisdom: 0, constitution: 12, strength: 12, defense: 8, moves: ['gnomeBomb', 'gnomeBomb', 'gnomeBomb', 'block', 'gnomeBomb'] },
        3: { level: '3', wisdom: 0, constitution: 14, strength: 14, defense: 10, moves: ['gnomeBomb', 'slash', 'gnomeBomb', 'block', 'gnomeBomb'] },
        4: { level: '4', wisdom: 0, constitution: 16, strength: 16, defense: 12, moves: ['gnomeBomb', 'slash', 'bellowAndSing(1,1)', 'block', 'gnomeBomb'] },
