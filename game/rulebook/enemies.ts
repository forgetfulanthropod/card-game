...
export const enemies: Record<EnemyCharacterId, Record<Level, EnemyDefinition>> = {
    ...
    matchaGelatinCube: {
        ...
        8: { level: '8', wisdom: 0, constitution: 160, strength: 50, defense: 41, moves: ['basicAttack', 'surpriseAllergy(4,2)', 'itchyOoze(7)', 'block', 'engulf(75)'] },
        9: { level: '9', wisdom: 0, constitution: 175, strength: 56, defense: 48, moves: ['basicAttack', 'surpriseAllergy(4,2)', 'itchyOoze(8)', 'block', 'engulf(75)'] },
        10: { level: '10', wisdom: 0, constitution: 200, strength: 62, defense: 56, moves: ['basicAttack', 'surpriseAllergy(5,2)', 'itchyOoze(9)', 'block', 'engulf(75)'] },
        large: { level: 'large', wisdom: 0, constitution: '200-100', strength: 68, defense: 20, moves: ['matchaMash', 'matchaMadness', 'matchaMeld', 'surpriseAllergy(2,1)', 'surpriseAllergy(2,1)'] },
        medium: { level: 'medium', wisdom: 0, constitution: '99-30', strength: 74, defense: 10, moves: ['matchaMash', 'surpriseAllergy(2,1)', 'surpriseAllergy(2,1)', 'surpriseAllergy(2,1)', 'surpriseAllergy(2,1)'] },
        small: { level: 'small', wisdom: 0, constitution: '>29', strength: 80, defense: 5, moves: ['matchaMash', 'surpriseAllergy(2,1)', 'surpriseAllergy(2,1)', 'surpriseAllergy(2,1)', 'surpriseAllergy(2,1)'] },
    },
    gnomeHooligan: {
        1: { level: '1', wisdom: 0, constitution: 10, strength: 10, defense: 6, moves: ['gnomeBomb(1)', 'bellowAndSing(1,1)', 'gnomeBomb(1)', 'block', 'gnomeBomb(1)'] },
        2: { level: '2', wisdom: 0, constitution: 12, strength: 12, defense: 8, moves: ['gnomeBomb(1)', 'bellowAndSing(1,1)', 'gnomeBomb(2)', 'block', 'gnomeBomb(1)'] },
        3: { level: '3', wisdom: 0, constitution: 14, strength: 14, defense: 10, moves: ['gnomeBomb(1)', 'slash', 'gnomeBomb(1)', 'block', 'gnomeBomb(1)'] },
        4: { level: '4', wisdom: 0, constitution: 16, strength: 16, defense: 12, moves: ['gnomeBomb(1)', 'slash', 'bellowAndSing(1,1)', 'block', 'gnomeBomb(1)'] },
        5: { level: '5', wisdom: 0, constitution: 18, strength: 18, defense: 14, moves: ['gnomeBomb(1)', 'slash', 'bellowAndSing(2,2)', 'block', 'screamAndCharge(100,1)'] },
        6: { level: '6', wisdom: 0, constitution: 20, strength: 20, defense: 16, moves: ['gnomeBomb(1)', 'slash', 'bellowAndSing(2,2)', 'block', 'screamAndCharge(100,1)'] },
        7: { level: '7', wisdom: 0, constitution: 22, strength: 22, defense: 19, moves: ['gnomeBomb(1)', 'slash', 'bellowAndSing(2,2)', 'block', 'screamAndCharge(100,2)'] },
        8: { level: '8', wisdom: 0, constitution: 24, strength: 24, defense: 22, moves: ['gnomeBomb(1)', 'slash', 'bellowAndSing(2,2)', 'block', 'screamAndCharge(125,2)'] },
        9: { level: '9', wisdom: 0, constitution: 26, strength: 26, defense: 25, moves: ['gnomeBomb(1)', 'slash', 'bellowAndSing(2,1)', 'block', 'screamAndCharge(125,2)'] },
        10: { level: '10', wisdom: 0, constitution: 28, strength: 28, defense: 28, moves: ['gnomeBomb(1)', 'slash', 'bellowAndSing(2,2)', 'block', 'screamAndCharge(125,2)'] },
    },
    orcWarrior: {
        1: { level: '1', wisdom: 0, constitution: 15, strength: 14, defense: 6, moves: ['meatyCharge(1)', 'meatyCharge(1)', 'meatyCharge(1)', 'block', 'meatyCharge(1)'] },
        2: { level: '2', wisdom: 0, constitution: 33, strength: 20, defense: 8, moves: ['meatyCharge(1)', 'meatyCharge(1)', 'meatyCharge(1)', 'block', 'meatyCharge(1)'] },
        3: { level: '3', wisdom: 0, constitution: 50, strength: 26, defense: 10, moves: ['meatyCharge(1)', 'slash', 'meatyCharge(1)', 'block', 'meatyCharge(1)'] },
        4: { level: '4', wisdom: 0, constitution: 75, strength: 32, defense: 12, moves: ['meatyCharge(1)', 'slash', 'bellowAndSing(1,1)', 'block', 'meatyCharge(1)'] },
