const data = {
    ...
    totalFrames: 13,
    assets: {
        "KC_FX_BasicAttack005_Player_v01": "images/KC_FX_BasicAttack005_Player_v01.shapes.txt"
    },
    lib: {},
    shapes: {},
    textures: {},
    ...
    setup: function (animate) {
        ...
        const Graphic4 = class extends MovieClip {
            constructor(mode) {
                ...
                const instance1 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_BasicAttack005_Player_v01[0]);
                const instance2 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_BasicAttack005_Player_v01[1]);
                const instance3 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_BasicAttack005_Player_v01[2]);
                const instance4 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_BasicAttack005_Player_v01[3]);
        ...
        const Graphic5 = class extends MovieClip {
            constructor(mode) {
                super({ mode: mode, duration: 13, loop: false });
                const instance2 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_BasicAttack005_Player_v01[4]);
                const instance3 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_BasicAttack005_Player_v01[5]);
                const instance5 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_BasicAttack005_Player_v01[6]);
                const instance6 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_BasicAttack005_Player_v01[7]);
                const instance8 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_BasicAttack005_Player_v01[8]);
                const instance9 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_BasicAttack005_Player_v01[9]);
        ...
        data.lib.KC_FX_BasicAttack005_Player_v01 = class extends MovieClip {
            constructor() {
                super({
                    duration: 13,
                    framerate: 24
                ...
                const instance1 = new Graphic5(MovieClip.SYNCHED)
                    .setTransform(122.1, 87.75, 0.562, 0.562, 0, 0, 3.142);
                this.addTimedChild(instance1);
            }
        };
        data.stage = data.lib.KC_FX_BasicAttack005_Player_v01;
    }
};
