const data = {
    ...
    totalFrames: 34,
    assets: {
        "KC_FX_Poison_001_Enemy_v01": "images/KC_FX_Poison_001_Enemy_v01.shapes.txt"
    },
    lib: {},
    shapes: {},
    textures: {},
    ...
    setup: function (animate) {
        ...
        const Graphic8 = class extends MovieClip {
            constructor(mode) {
                ...
                const instance1 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_Poison_001_Enemy_v01[0]);
                const instance2 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_Poison_001_Enemy_v01[1]);
                const instance3 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_Poison_001_Enemy_v01[2]);
        ...
        const Graphic9 = class extends MovieClip {
            constructor(mode) {
                super({ mode: mode, duration: 30, loop: false });
                const instance1 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_Poison_001_Enemy_v01[7]);
                const instance3 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_Poison_001_Enemy_v01[8]);
                const instance2 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_Poison_001_Enemy_v01[3]);
                const instance5 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_Poison_001_Enemy_v01[9]);
                const instance4 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_Poison_001_Enemy_v01[4]);
                const instance6 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_Poison_001_Enemy_v01[5]);
                const instance8 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_Poison_001_Enemy_v01[10]);
                const instance7 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_Poison_001_Enemy_v01[6]);
                this.addTimedChild(instance1, 0, 1)
        ...
        const Graphic3 = class extends MovieClip {
            constructor(mode) {
                ...
                const instance1 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_Poison_001_Enemy_v01[11]);
                const instance2 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_Poison_001_Enemy_v01[12]);
                const instance3 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_Poison_001_Enemy_v01[13]);
                const instance4 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_Poison_001_Enemy_v01[14]);
                const instance5 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_Poison_001_Enemy_v01[15]);
                this.addTimedChild(instance1, 0, 1)
                    .addTimedChild(instance2, 1, 1)
        ...
        const Graphic6 = class extends MovieClip {
            constructor(mode) {
                ...
                const instance1 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_Poison_001_Enemy_v01[16]);
                const instance2 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_Poison_001_Enemy_v01[17]);
                const instance3 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_Poison_001_Enemy_v01[18]);
                const instance4 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_Poison_001_Enemy_v01[19]);
                const instance5 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_Poison_001_Enemy_v01[20]);
                const instance6 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_Poison_001_Enemy_v01[21]);
                const instance7 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_Poison_001_Enemy_v01[22]);
                const instance8 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_Poison_001_Enemy_v01[23]);
                const instance9 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_Poison_001_Enemy_v01[24]);
                const instance10 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_Poison_001_Enemy_v01[25]);
                const instance11 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_Poison_001_Enemy_v01[26]);
                const instance12 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_Poison_001_Enemy_v01[27]);
                this.addTimedChild(instance1, 0, 1)
                    .addTimedChild(instance2, 1, 1)
                    .addTimedChild(instance3, 2, 1)
        ...
        const Graphic7 = class extends MovieClip {
            constructor(mode) {
                super({ mode: mode, duration: 31, loop: false });
                const instance1 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_Poison_001_Enemy_v01[28]);
                const instance2 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_Poison_001_Enemy_v01[29]);
                const instance3 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_Poison_001_Enemy_v01[30]);
                const instance4 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_Poison_001_Enemy_v01[31]);
                const instance5 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_Poison_001_Enemy_v01[32]);
                const instance6 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_Poison_001_Enemy_v01[33]);
                const instance7 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_Poison_001_Enemy_v01[34]);
                const instance8 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_Poison_001_Enemy_v01[35]);
                const instance9 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_Poison_001_Enemy_v01[36]);
                const instance10 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_Poison_001_Enemy_v01[37]);
                this.addTimedChild(instance1, 0, 1)
                    .addTimedChild(instance2, 1, 1)
                    .addTimedChild(instance3, 2, 2)
        ...
        const Graphic12 = class extends MovieClip {
            constructor(mode) {
                ...
                const instance1 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_Poison_001_Enemy_v01[38]);
                const instance2 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_Poison_001_Enemy_v01[39]);
                const instance3 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_Poison_001_Enemy_v01[40]);
                const instance4 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_Poison_001_Enemy_v01[41]);
                const instance5 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_Poison_001_Enemy_v01[42]);
                const instance6 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_Poison_001_Enemy_v01[43]);
                const instance7 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_Poison_001_Enemy_v01[44]);
                const instance8 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_Poison_001_Enemy_v01[45]);
                const instance9 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_Poison_001_Enemy_v01[46]);
                const instance10 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_Poison_001_Enemy_v01[47]);
                const instance11 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_Poison_001_Enemy_v01[48]);
                const instance12 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_Poison_001_Enemy_v01[49]);
        ...
        data.lib.KC_FX_Poison_001_Enemy_v01 = class extends MovieClip {
            constructor() {
                super({
                    duration: 34,
                    framerate: 24
                ...
                const instance1 = new Graphic13(MovieClip.SYNCHED)
                    .setTransform(111.55, 112.2, 0.414, 0.414, 0, 0, 3.142);
                this.addTimedChild(instance1);
            }
        };
        data.stage = data.lib.KC_FX_Poison_001_Enemy_v01;
    }
};
