const data = {
    ...
    totalFrames: 22,
    assets: {
        "KC_FX_BasicAttack002_v01": "images/KC_FX_BasicAttack002_v01.shapes.txt"
    },
    lib: {},
    shapes: {},
    textures: {},
    ...
    setup: function (animate) {
        ...
        const Graphic2 = class extends MovieClip {
            constructor(mode) {
                ...
                const instance1 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_BasicAttack002_v01[9]);
                const instance2 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_BasicAttack002_v01[10]);
                const instance3 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_BasicAttack002_v01[11]);
                const instance4 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_BasicAttack002_v01[12]);
                const instance5 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_BasicAttack002_v01[13]);
        ...
        const Graphic1 = class extends MovieClip {
            constructor(mode) {
                ...
                const instance1 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_BasicAttack002_v01[14]);
                const instance2 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_BasicAttack002_v01[15]);
                const instance3 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_BasicAttack002_v01[16]);
                const instance4 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_BasicAttack002_v01[17]);
                const instance5 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_BasicAttack002_v01[18]);
                this.addTimedChild(instance1, 0, 1)
                    .addTimedChild(instance2, 1, 1)
                    .addTimedChild(instance3, 2, 1)
                    .addTimedChild(instance4, 3, 1)
        ...
        const Graphic3 = class extends MovieClip {
            constructor(mode) {
                ...
                const instance1 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_BasicAttack002_v01[19]);
                const instance3 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_BasicAttack002_v01[20]);
                const instance4 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_BasicAttack002_v01[21]);
                const instance5 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_BasicAttack002_v01[22]);
                const instance6 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_BasicAttack002_v01[23]);
        ...
        const Graphic4 = class extends MovieClip {
            constructor(mode) {
                ...
                const instance3 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_BasicAttack002_v01[0]);
                const instance4 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_BasicAttack002_v01[1]);
                const instance5 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_BasicAttack002_v01[2]);
                const instance6 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_BasicAttack002_v01[3]);
                const instance7 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_BasicAttack002_v01[4]);
                const instance8 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_BasicAttack002_v01[5]);
                const instance9 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_BasicAttack002_v01[6]);
                const instance10 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_BasicAttack002_v01[7]);
                const instance11 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_BasicAttack002_v01[8]);
        ...
        data.lib.KC_FX_BasicAttack002_v01 = class extends MovieClip {
            constructor() {
                super({
                    duration: 22,
                    framerate: 24
        ...
        data.stage = data.lib.KC_FX_BasicAttack002_v01;
    }
};
