const data = {
    ...
    totalFrames: 39,
    assets: {
        "KC_FX_AdvancedAttack001_Enemy_v01": "images/KC_FX_AdvancedAttack001_Enemy_v01.shapes.txt"
    },
    lib: {},
    shapes: {},
    textures: {},
    ...
    setup: function (animate) {
        ...
        const Graphic7 = class extends MovieClip {
            constructor(mode) {
                ...
                const instance1 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_AdvancedAttack001_Enemy_v01[2]);
                const instance2 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_AdvancedAttack001_Enemy_v01[3]);
                const instance3 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_AdvancedAttack001_Enemy_v01[4]);
                const instance4 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_AdvancedAttack001_Enemy_v01[5]);
        ...
        const Graphic10 = class extends MovieClip {
            constructor(mode) {
                ...
                const instance1 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_AdvancedAttack001_Enemy_v01[6]);
                const instance2 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_AdvancedAttack001_Enemy_v01[7]);
                const instance3 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_AdvancedAttack001_Enemy_v01[8]);
                const instance4 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_AdvancedAttack001_Enemy_v01[9]);
                const instance5 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_AdvancedAttack001_Enemy_v01[10]);
                const instance6 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_AdvancedAttack001_Enemy_v01[11]);
                const instance7 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_AdvancedAttack001_Enemy_v01[12]);
                const instance8 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_AdvancedAttack001_Enemy_v01[13]);
        ...
        const Graphic12 = class extends MovieClip {
            constructor(mode) {
                ...
                const instance1 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_AdvancedAttack001_Enemy_v01[0]);
                const instance3 = new Graphic2(MovieClip.SYNCHED);
                const instance5 = new Graphic3(MovieClip.SYNCHED);
                const instance4 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_AdvancedAttack001_Enemy_v01[1]);
        ...
        data.lib.KC_FX_AdvancedAttack001_Enemy_v01 = class extends MovieClip {
            constructor() {
                super({
                    duration: 39,
                    framerate: 24
                ...
                const instance1 = new Graphic12(MovieClip.SYNCHED)
                    .setTransform(88.2, 157.25, 0.369, 0.369);
                this.addTimedChild(instance1);
            }
        };
        data.stage = data.lib.KC_FX_AdvancedAttack001_Enemy_v01;
    }
};
