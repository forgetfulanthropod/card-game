const data = {
    ...
    totalFrames: 14,
    assets: {
        "KC_FX_BasicAttack001_Enemy_v01": "images/KC_FX_BasicAttack001_Enemy_v01.shapes.txt"
    },
    lib: {},
    shapes: {},
    textures: {},
    ...
    setup: function (animate) {
        ...
        const Graphic2 = class extends MovieClip {
            constructor(mode) {
                ...
                const instance1 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_BasicAttack001_Enemy_v01[0]);
                const instance2 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_BasicAttack001_Enemy_v01[1]);
                const instance3 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_BasicAttack001_Enemy_v01[2]);
                const instance4 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_BasicAttack001_Enemy_v01[3]);
                const instance5 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_BasicAttack001_Enemy_v01[4]);
                const instance6 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_BasicAttack001_Enemy_v01[5]);
                const instance7 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_BasicAttack001_Enemy_v01[6]);
                const instance8 = new Graphics()
                    .drawCommands(data.shapes.KC_FX_BasicAttack001_Enemy_v01[7]);
        ...
        data.lib.KC_FX_BasicAttack001_Enemy_v01 = class extends MovieClip {
            constructor() {
                super({
                    duration: 14,
                    framerate: 24
        ...
        data.stage = data.lib.KC_FX_BasicAttack001_Enemy_v01;
    }
};
