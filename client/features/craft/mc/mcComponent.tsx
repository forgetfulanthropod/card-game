...
export default function mcComponent() {
    return (
        <div id="screen">
            ...
            <div id="inventory">
                <div class="gridCell" onClick="selectInventoryItem(0);" id="inventory-0">
                    <img src="http://www.101computing.net/mc/4-0.png" alt="Cobblestone" />
                </div>
                <div class="gridCell" onClick="selectInventoryItem(1);" id="inventory-1">
                    <img src="http://www.101computing.net/mc/17-0.png" alt="Wood" />
                </div>
                <div class="gridCell" onClick="selectInventoryItem(2);" id="inventory-2">
                    <img src="http://www.101computing.net/mc/265-0.png" alt="Iron ingot" />
                </div>
                <div class="gridCell" onClick="selectInventoryItem(3);" id="inventory-3">
                    <img src="http://www.101computing.net/mc/266-0.png" alt="Gold" />
                </div>
                <div class="gridCell" onClick="selectInventoryItem(4);" id="inventory-4">
                    <img src="http://www.101computing.net/mc/264-0.png" alt="Diamond" />
                </div>
                <div class="gridCell" onClick="selectInventoryItem(5);" id="inventory-5">
                    <img src="http://www.101computing.net/mc/331-0.png" alt="Red Stone" />
                </div>
                <div class="gridCell" onClick="selectInventoryItem(6);" id="inventory-6">
                    <img src="http://www.101computing.net/mc/287-0.png" alt="String" />
                </div>
                <div class="gridCell" onClick="selectInventoryItem(7);" id="inventory-7">
                    <img src="http://www.101computing.net/mc/288-0.png" alt="Feather" />
                </div>
                <div class="gridCell" onClick="selectInventoryItem(8);" id="inventory-8">
                    <img src="http://www.101computing.net/mc/318-0.png" alt="Flint" />
                </div>
                <div class="gridCell" onClick="selectInventoryItem(9);" id="inventory-9">
                    <img src="http://www.101computing.net/mc/263-0.png" alt="Coal" />
                </div>
