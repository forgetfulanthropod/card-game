...
export default function CharacterDetailPage(props: PageProps): JSXElement {
    ...
    const cards = <GridItem colSpan={[4, 4, 4, 1]}>
        <Text>Battle</Text>
        <SimpleGrid columns={2} spacing={1}>
            {imageSrcs.map(src => <Image width={200} key={src} src={src} />)}
        </SimpleGrid>
    </GridItem>

    const character = <GridItem colSpan={[4, 4, 4, 2]}>
    ...
    const gatherCraft = <GridItem colSpan={[4, 4, 4, 1]}>
