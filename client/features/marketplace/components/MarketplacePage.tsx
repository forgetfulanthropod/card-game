...
import mush from '@/features/battle/assets/gen0_cards/Mushroom_Farmer2-200.png'
import peng from '@/features/battle/assets/gen0_cards/PenguinKnight-200.png'
...
export default function MarketplacePage(props: PageProps): JSXElement {
    const tableData = [
        ...
        [
            <img key={mimic} src={mimic} />,
            'mimic',
            '11 SOL',
            <Button key={'mimic'}>Buy</Button>,
            1,
            70,
            83,
            37,
        ...
        [
            <img key={mush} src={mush} />,
            'mush',
            '10 SOL',
            <Button key={'mush'}>Buy</Button>,
            97,
            92,
            89,
            70,
        ...
        [
            <img key={peng} src={peng} />,
            'peng',
            '16 SOL',
            <Button key={'peng'}>Buy</Button>,
            72,
            73,
            50,
            67,
        ...
        [
            <img key={snacky} src={snacky} />,
            'snacky',
            '5 SOL',
            <Button key={'snacky'}>Buy</Button>,
            14,
            63,
            12,
            3,
