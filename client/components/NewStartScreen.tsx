...
export function NewStartScreen(props: {
    ...
    return <div className='grid grid-rows-4 absolute left-0 w-full h-full pointer-events-auto'>
        ...
        <div className='nav w-full row-span-1 flex p-8 justify-between items-start'>
            <div className='flex w-12 2xs:w-14 xs:w-18 sm:w-32 xl:w-56 cursor-pointer hover:scale-105 transition'>
                <img src='./logos/KaijuCards.png' />
            </div>
            <div className='navRight flex justify-between sm:pl-12 pt-4 items-start w-full'>
        ...
        <div className='bottom h-full row-span-3 grid grid-cols-12'>
            <div className='left-buttons h-full col-span-4 flex flex-col justify-end gap-2 sm:gap-8 p-1 sm:p-3 md:p-5 xl:gap-6 xl:p-10'>
                <PrimaryButton
                    text='tutorial'
                    onClick={() =>
            ...
            <div className='mid-buttons h-full col-span-4 flex items-end gap-2 sm:gap-8 p-1 sm:p-3 md:p-5 xl:gap-6 xl:p-10'>
                <div className='h-1/6 w-full flex xl:pt-4 xl:gap-4'>
                    <PrimaryButton
                        text='quests'
                        onClick={() =>
            ...
            <div className='right-buttons h-full col-span-4 flex flex-col justify-end gap-2 sm:gap-8 p-1 sm:p-3 md:p-5 xl:gap-6 xl:p-10'>
                <GameModeContainer
