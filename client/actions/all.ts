import type { Action as AllTypes } from 'shared/actions'
...
export const changeDungeon =
    callWrap<AllTypes['ChangeDungeon']>('changeDungeon')
...
export const endTurn = callWrap<AllTypes['EndTurn']>('endTurn')
...
export const maybeMakeUser =
    callWrap<AllTypes['MaybeMakeUser']>('maybeMakeUser')
